...
const EnvironmentButton = ( {handleDeleteEnvironment, handleRenameEnvironment, id, EnvName} ) => {
  console.log("in EnvironmentButton, id is", id, "EnvName is", EnvName)

  return (
    <>
       <button className="environment-dropdown-btn">
          <svg className="environment-dropdown-icon" onClick = {() => handleRenameEnvironment(id, "NewName bruh!" + id)}xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
